...
def VCFtoFASTA(member):
	...
	gaps1 = 0
	gaps2 = 0
	#print len(sequence1), len(sequence2), len(refwin)
	#print "\n".join("".join(sequence1[i:i+60]) for i in xrange(0, len(sequence1), 60))+"\n"
	#print "\n".join("".join(sequence2[i:i+60]) for i in xrange(0, len(sequence2), 60))+"\n"
